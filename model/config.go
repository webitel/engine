...
type MessageQueueSettings struct {
	Url string `json:"url" flag:"amqp|amqp://webitel:webitel@rabbit:5672?heartbeat=10|AMQP connection" env:"AMQP"`
}
...
type CaseTriggersSettings struct {
	...
	Topic            string `json:"topic" flag:"case_trigger_topic|trigger_case_*|Topic name for triggers cases" env:"CASE_TRIGGER_TOPIC"`
	QueueMessagesTTL string `json:"Queue_messages_ttl" flag:"case_trigger_queue_messages_ttl|10000|Queue messages TTL for triggers cases" env:"CASE_TRIGGER_QUEUE_MESSAGES_TTL"`
}
