...
func (app *App) AuditCreate(ctx context.Context, session *auth_manager.Session, object string, recordId string, data interface{}) {
...
func (app *App) AuditUpdate(ctx context.Context, session *auth_manager.Session, object string, recordId string, data interface{}) {
...
func (app *App) AuditDelete(ctx context.Context, session *auth_manager.Session, object string, recordId string, data interface{}) {
