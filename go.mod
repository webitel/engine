...
require (
	...
	buf.build/gen/go/webitel/engine/grpc/go v1.4.0-20240618123100-3e740393d1cc.1
	buf.build/gen/go/webitel/engine/protocolbuffers/go v1.34.2-20240618123100-3e740393d1cc.2
