...
require (
	...
	buf.build/gen/go/webitel/engine/grpc/go v1.5.1-20250404063355-076588cc0acd.2
	buf.build/gen/go/webitel/engine/protocolbuffers/go v1.36.6-20250404063355-076588cc0acd.1
