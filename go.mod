...
require (
	...
	buf.build/gen/go/webitel/engine/grpc/go v1.3.0-20240513122855-9d9f01efd1a2.3
	buf.build/gen/go/webitel/engine/protocolbuffers/go v1.34.1-20240513122855-9d9f01efd1a2.1
