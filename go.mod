...
require (
	...
	buf.build/gen/go/webitel/engine/grpc/go v1.5.1-20240911121455-f88954ec392c.1
	buf.build/gen/go/webitel/engine/protocolbuffers/go v1.34.2-20240911121455-f88954ec392c.2
