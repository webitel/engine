...
require (
	...
	buf.build/gen/go/webitel/engine/grpc/go v1.5.1-20241112102438-4705266eb2f9.1
	buf.build/gen/go/webitel/engine/protocolbuffers/go v1.35.1-20241112102438-4705266eb2f9.1
