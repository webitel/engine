...
require (
	...
	buf.build/gen/go/webitel/engine/grpc/go v1.5.1-20250425074307-5b6cc03b8cb9.2
	buf.build/gen/go/webitel/engine/protocolbuffers/go v1.36.6-20250425074307-5b6cc03b8cb9.1
