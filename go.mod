...
require (
	...
	buf.build/gen/go/webitel/engine/grpc/go v1.5.1-20240924085830-91cbef39a006.1
	buf.build/gen/go/webitel/engine/protocolbuffers/go v1.34.2-20240924085830-91cbef39a006.2
