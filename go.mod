...
require (
	...
	buf.build/gen/go/webitel/engine/grpc/go v1.4.0-20240627102531-08342cefa670.1
	buf.build/gen/go/webitel/engine/protocolbuffers/go v1.34.2-20240627102531-08342cefa670.2
