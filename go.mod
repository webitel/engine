...
require (
	...
	buf.build/gen/go/webitel/engine/grpc/go v1.5.1-20250501130812-1d980782ff47.2
	buf.build/gen/go/webitel/engine/protocolbuffers/go v1.36.6-20250501130812-1d980782ff47.1
