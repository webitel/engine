...
var (
	allSystemSettings = []string{model.SysNameOmnichannel, model.SysNameMemberInsertChunkSize, model.SysNameSchemeVersionLimit,
		...
		model.SysNamePasswordMinLength, model.SysNamePasswordCategories, model.SysNamePasswordContainsUsername, model.SysNamePasswordWarningDays, model.SysNameDefaultPassword,
	}
)
