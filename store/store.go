...
type MemberStore interface {
	...
	MutateHistoryAttemptResult(ctx context.Context, mutation *model.MutateHistoryAttempt) (*model.AttemptHistory, model.AppError)
}
...
type CallStore interface {
	...
	SetContactId(ctx context.Context, domainId int64, id string, contactId int64) (*model.CallDomain, model.AppError)
...
type QuickReplyStore interface {
	...
	GetAllPageByAgentPriority(ctx context.Context, domainId, userId int64, search *model.SearchQuickReply) ([]*model.QuickReply, model.AppError)
