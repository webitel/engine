protoc -I/usr/local/include -I../grpc_api/proto -I$GOPATH/src/github.com/grpc-ecosystem/grpc-gateway/third_party/googleapis  \
  ...
  --swagger_out=version=false,json_names_for_fields=false,include_package_in_tags=false,allow_repeated_fields_in_body=false,fqn_for_swagger_name=false,merge_file_name=api,allow_merge=true:./api \
