...
func (c *authClient) Signup(ctx context.Context, in *LoginRequest, opts ...grpc.CallOption) (*LoginResponse, error) {
...
func (UnimplementedAuthServer) Signup(context.Context, *LoginRequest) (*LoginResponse, error) {
...
func _Auth_Signup_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServer).Signup(ctx, req.(*LoginRequest))
	}
	return interceptor(ctx, in, info, handler)
}
