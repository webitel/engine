...
type Chat interface {
	...
	Leave(authUserId int64, channelId, conversationId string, cause LeaveCause) error
	CloseConversation(authUserId int64, channelId, conversationId string, cause CloseCause) error

	SendText(authUserId int64, channelId, conversationId, text string) error
	SendFile(authUserId int64, channelId, conversationId string, file *ChatFile) error
