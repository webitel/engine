...
const CODE_RESPONSE_ERRORS = ["UNALLOCATED_NUMBER", END_CAUSE.NO_ROUTE, END_CAUSE.MEMBER_EXPIRED, 'CHAN_NOT_IMPLEMENTED', "INVALID_NUMBER_FORMAT", "NETWORK_OUT_OF_ORDER", "OUTGOING_CALL_BARRED", "SERVICE_UNAVAILABLE", "CHAN_NOT_IMPLEMENTED", "SERVICE_NOT_IMPLEMENTED", "INCOMPATIBLE_DESTINATION", "MANDATORY_IE_MISSING", "PROGRESS_TIMEOUT", "GATEWAY_DOWN"];
