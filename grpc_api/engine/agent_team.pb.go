...
func (*AgentTeam) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{0} }
...
func (*ListAgentTeam) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{1} }
...
type AgentTeamApiClient interface {
	...
	List(ctx context.Context, in *ListReqeust, opts ...grpc.CallOption) (*ListAgentTeam, error)
...
func (c *agentTeamApiClient) List(ctx context.Context, in *ListReqeust, opts ...grpc.CallOption) (*ListAgentTeam, error) {
...
type AgentTeamApiServer interface {
	...
	List(context.Context, *ListReqeust) (*ListAgentTeam, error)
...
func _AgentTeamApi_List_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AgentTeamApiServer).List(ctx, req.(*ListReqeust))
	}
	return interceptor(ctx, in, info, handler)
}
...
func init() { proto.RegisterFile("agent_team.proto", fileDescriptor0) }
...
var fileDescriptor0 = []byte{
	...
	0x3f, 0x55, 0x46, 0xb5, 0x9d, 0xc5, 0x5f, 0xd8, 0xfa, 0x23, 0x38, 0xf3, 0x77, 0x51, 0xec, 0xd1,
	...
	0x51, 0x80, 0x8b, 0x3f, 0x31, 0xa4, 0x9b, 0xd6, 0xdc, 0xa2, 0xd0, 0xec, 0x19, 0x0c, 0x94, 0xe4,
	...
	0x16, 0x77, 0xa5, 0xb1, 0xa5, 0x30, 0xee, 0x16, 0x6b, 0x9e, 0xe4, 0xd1, 0x72, 0x54, 0x64, 0x5a,
	0xdc, 0xfd, 0xb0, 0x1b, 0x8f, 0x58, 0x0e, 0x93, 0xdb, 0x5a, 0x54, 0x65, 0x53, 0x95, 0xa4, 0x34,
	...
	,
}
