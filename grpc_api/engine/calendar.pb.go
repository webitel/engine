...
func (*ListCalendar) Descriptor() ([]byte, []int) { return fileDescriptor5, []int{0} }
...
func (*Calendar) Descriptor() ([]byte, []int) { return fileDescriptor5, []int{1} }
...
func (*ListTimezoneResponse) Descriptor() ([]byte, []int) { return fileDescriptor5, []int{2} }
...
func (*Timezone) Descriptor() ([]byte, []int) { return fileDescriptor5, []int{3} }
...
func (*AcceptOfDay) Descriptor() ([]byte, []int) { return fileDescriptor5, []int{4} }
...
func (*AcceptOfDayReqeust) Descriptor() ([]byte, []int) { return fileDescriptor5, []int{5} }
...
func (*ListAcceptOfDay) Descriptor() ([]byte, []int) { return fileDescriptor5, []int{6} }
...
func init() { proto.RegisterFile("calendar.proto", fileDescriptor5) }
